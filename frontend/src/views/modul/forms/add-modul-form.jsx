...
import { getModul } from "@/api/modul";
...
const AddModul = ({ visible, onCancel, onOk, confirmLoading }) => {
        ...
        <Row gutter={16}>
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item
              label="Nama Modul:"
              name="namaModul"
              rules={[{ required: true, message: "Silahkan isi Nama Modul" }]}
            >
